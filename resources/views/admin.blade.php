                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    @endif
                                    <form class="user" method="POST" action="{{ route('giris.post') }}">
                                        @csrf
                                        <div class="form-group">
                                            <input type="email"  name="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="E-Mail Giriniz">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" name="password" id="exampleInputPassword" placeholder="Şifre Giriniz">
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{ route('kayit') }}">Kayıt Ol!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
